...
Driver.prototype.streamOdometer = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("odometer", function(data) {
    self.emit("Odometer", data);
  });
};

Driver.prototype.emitVelocity = function(data) {
  var self = this;
  console.log("Stream velocity2");
...
Driver.prototype.streamVelocity = function(sps, remove) {
  console.log("Stream velocity1");
  
  this.sphero.removeListener("velocity", this.emitVelocity);
  if (sps != 0 && !remove) {
    this.sphero.streamVelocity(sps, remove);
    this.sphero.once("velocity", this.emitVelocity);
  } else {
    this.sphero.streamVelocity(0, true);
    this.sphero.removeListener("velocity", this.emitVelocity);
  }
};
...
Driver.prototype.streamAccelOne = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("accelOne", function(data) {
...
Driver.prototype.streamImuAngles = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("imuAngles", function(data) {
...
Driver.prototype.streamAccelerometer = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("accelerometer", function(data) {
...
Driver.prototype.streamGyroscope = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("gyroscope", function(data) {
...
Driver.prototype.streamMotorsBackEmf = function(sps, remove) {
  ...
  var self = this;
  this.sphero.once("motorsBackEmf", function(data) {

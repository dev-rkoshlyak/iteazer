...
module.exports = function sphero(device) {
  ...
  device.simpleStringify = function(object) {
    var simpleObject = {};
  ...
  device.setDataStreaming = function(opts, callback) {
    ...
    console.log("\n\ndevice\n\n" + this.simpleStringify(device));
    console.log("\n\ndevice.command\n\n" + this.simpleStringify(device.command));
    console.log("\n\ncommand\n\n" + JSON.stringify(command));
      
//    if (opts.mask1 | opts.mask2 != 0) {
        console.log("masks: " + (opts.mask1 | opts.mask2) + "\n" + opts.mask1 + "\n"+ opts.mask2 + "\n");

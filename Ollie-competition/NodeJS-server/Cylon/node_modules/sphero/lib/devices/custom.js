...
module.exports = function custom(device) {
   ...
   * @return {void}
   */
  device.streamData = function(args, pcnt, callback) {
    pcnt = typeof pcnt  !== 'undefined' ? pcnt : 0;
    ...
    //    if (typeof this.cnt  !== 'undefined') this.cnt += 1;
  //      else this.cnt = 0;
...
//      console.log(JSON.stringify(data));
    ...
    device.setDataStreaming(opts, callback);
  };

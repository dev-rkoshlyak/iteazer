...
public class ServerCylonGenerator {
    ...
    private static ArrayList<String> generateRoll(ArrayList<Droid> droids) {
        ...
        functions.add(ENDL);
        functions.addAll(generateFunctionSelector("roll", "speed, direction,", "bb8", droids));
        functions.add("," + ENDL);
        
        functions.addAll(generateFunctionSelector("roll", "speed, direction,", "ollie", droids));
        functions.add(ENDL);
        functions.add(ENDL);
    ...
    private static ArrayList<String> generateFunctionSelector(String functName, String parameters, String type, ArrayList<Droid> droids) {
        ArrayList<String> function = new ArrayList<>();
        function.add(TAB[1] + String.format("%1$s_%2$s(my, mac, %3$s callback) {", functName, type, parameters));
    ...
    private static ArrayList<String> generateSetColor(ArrayList<Droid> droids) {
        ...
        functions.addAll(generateFunctionSelector("setColor", "newColor,", "bb8", droids));
        functions.add(",");
        functions.add(ENDL);

        //functions.addAll(generateSetColor("ollie", droids));
        functions.addAll(generateFunctionSelector("setColor", "newColor,", "ollie", droids));
        functions.add(ENDL);

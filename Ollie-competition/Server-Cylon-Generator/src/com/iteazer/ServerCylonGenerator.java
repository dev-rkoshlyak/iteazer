...
public class ServerCylonGenerator {
    ...
    public static void generateFile(String fileName, ArrayList<Droid> droids) {
    ...
    public static String generateBluetoothConnections(ArrayList<Droid> droids) {
    ...
    public static String generateDiveces(ArrayList<Droid> droids) {
        return TAB[1] + "devices: {" + ENDL + ENDL + TAB[1] + "}" + ENDL;
    }

    public static String generateConnection(Droid droid) {
    ...
    public static ArrayList<String> generateConnection(String type, ArrayList<Droid> droids) {
    ...
    public static ArrayList<String> generateConnections(ArrayList<Droid> droids) {
    ...
    public static ArrayList<String> generateRoll(String type, ArrayList<Droid> droids) {
    ...
    public static ArrayList<String> generateRoll(ArrayList<Droid> droids) {
        ArrayList<String> functions = new ArrayList<>();
    ...
    public static ArrayList<String> generateSetColor(String type, ArrayList<Droid> droids) {
        ArrayList<String> function = new ArrayList<>();
    ...
    public static ArrayList<String> generateSetColor(ArrayList<Droid> droids) {
        ArrayList<String> functions = new ArrayList<>();
    ...
    public static ArrayList<String> generate(ArrayList<Droid> droids) {
